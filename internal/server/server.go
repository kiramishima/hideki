...
func NewServer(cfg *config.Configuration, logger *zap.SugaredLogger, r *chi.Mux) *Server {
	return &Server{
		router: r,
		logger: logger,
		cfg:    cfg,
...
var Module = fx.Module("server",
	fx.Provide(func(cfg *config.Configuration, logger *zap.SugaredLogger, r *chi.Mux) *Server {
